...
export function getBundledTemplate(): string {
  // Try to read from bolt.template.yaml in project root (2 levels up from src/init)
  const templatePath = path.join(import.meta.dir, "../..", "bolt.template.yaml");
  ...
  // Minimal fallback if bolt.template.yaml not found
