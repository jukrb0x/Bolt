...
export class Logger {
  ...
  info(msg: string)  { this.log("INFO",  (s) => pc.green(s),  msg) }
  warn(msg: string)  { this.log("WARN",  (s) => pc.yellow(s), msg) }
  error(msg: string) { this.log("ERROR", (s) => pc.red(s),    msg) }
  debug(msg: string) { this.log("DEBUG", (s) => pc.dim(s),    msg) }
